...
<head>
  ...
  <style type="text/css">
    ...
    .header_update{
      ...
      font-size: 1rem;
      font-weight: bold; 
      text-shadow: 1px 1px 2px #909E9E;
    }
...
<div class="container">
    <!-- CONTENT -->
    <div class="col">
      <div class="card" style="background-color: #F2F5F5;">
        <div class="card-header">
              <button type="button" class="btn float-right" data-toggle="collapse" data-target="#navigation"><img src="/bootstrap-icons/list.svg" alt="" width="25" height="25"></button>
              <div class="row justify-content-center" style="text-shadow: 1px 1px #839191;">
              @yield('header')
            </div>
        </div>
        <div class="card-body">
