...
<div class="main-banner" id="top">
    ...
    <div class="video-overlay header-text">
        <div class="caption">
            ...
            <h2>Showroom <em>Terbaik</em> Di Komunitas</h2>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="trainer-item">
                    <div class="image-thumb">
                        <img src="{{ asset('assets/vendor/showroom/assets/images/product-1-720x480.jpg') }}" alt="">
                    </div>
            ...
            <div class="col-lg-4">
                <div class="trainer-item">
                    <div class="image-thumb">
                        <img src="{{ asset('assets/vendor/showroom/assets/images/product-2-720x480.jpg') }}" alt="">
                    </div>
                    <div class="down-content">
                        <span>
                            <del><sup>$</sup>11999 </del> &nbsp; <sup>$</sup>11779
            ...
            <div class="col-lg-4">
                <div class="trainer-item">
                    <div class="image-thumb">
                        <img src="{{ asset('assets/vendor/showroom/assets/images/product-3-720x480.jpg') }}" alt="">
                    </div>
                    <div class="down-content">
                        <span>
                            <del><sup>$</sup>11999 </del> &nbsp; <sup>$</sup>11779
