...
<div class="container">
	...
	<form action="{{ '/showroom/autoshop/edit' }}" method="post" enctype="multipart/form-data">
		@csrf
		...
		<div class="form-group">
			<div class="form-row">
				<div class="col">
					...
					<input type="text" class="form-control" id="nama" name="nama" placeholder="nama bengkel" value="{{ $bengkel->nama }}">
				</div>
				<div class="col">
		...
		<div class="form-group">
			<div class="form-row">
				<div class="col">
					...
					<input type="text" class="form-control" id="hari" name="hari" placeholder="Contoh: Senin-Sabtu" value="{{ $bengkel->hari }}">
				</div>
				<div class="col">
					<label for="wb">Waktu Buka</label>
					<input type="time" class="form-control" id="wb" name="waktu_buka" value="{{ $bengkel->waktu_buka }}">
				</div>
				<div class="col">
					<label for="wt">Waktu Tutup</label>
					<input type="time" class="form-control" id="wt" name="waktu_tutup" value="{{ $bengkel->waktu_tutup }}">
				</div>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<textarea class="form-control" id="alamat" name="alamat" placeholder="Alamat Lengkap">{{ $bengkel->alamat }}</textarea>
		</div>
	    <div class="form-group">
			<label for="kontak">Kontak Bengkel</label>
			<input type="number" class="form-control" id="kontak" name="kontak" placeholder="Nomor Telepon" value="{{ $bengkel->kontak }}">
	    </div>
	    <div class="form-group">
