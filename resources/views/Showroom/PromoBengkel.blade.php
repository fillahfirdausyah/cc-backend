...
<div class="container mt-3">
	<div class="card">
		<form method="POST" action="{{ '/showroom/bengkel/promo/'.$bengkel->id }}">
			@csrf
		  	<div class="form-row justify-content-center">
		    	<div class="form-group col-md-6">
		      	<h3 class="text-center">~Tambahkan Promo~</h3>
		      	<textarea rows="10" class="form-control" id="promo" name="promo" placeholder="Tulis promonya apa aja gan!"></textarea>
		    	</div>
		  	</div>
